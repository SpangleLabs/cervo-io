...
describe("All zoos listing endpoint", function() {
    it('should list all zoos', function (done) {
        const mockZoosProvider = new MockZoosProvider([
            {zoo_id: 1, name: "Zoo one", link: "http://example.com/zoo_1", postcode: "SA1 1AA", latitude: 15.012, longitude: -122.522 },
            {zoo_id: 2, name: "Zoo two", link: "http://example.com/zoo_2", postcode: "CA1 1AA", latitude: 74.232, longitude: 83.245 },
            {zoo_id: 3, name: "Zoo three", link: "http://example.com/zoo_3", postcode: "NN14 1AA", latitude: -43.765, longitude: 35.671 }
        ]);
