...
export const BoxUnchecked: React.FunctionComponent = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="1em" height="1em" viewBox="0 0 100 100" xmlSpace="preserve">
